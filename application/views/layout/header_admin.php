                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/list_product/index');?>">
                                <i class="far fa-check-square"></i>List Product</a>
                        </li>
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/stock/index');?>">
                                <i class="fas fa-calendar-alt"></i>Stock</a>
                        </li>
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/list_stock/index');?>">
                                <i class="fas fa-map-marker-alt"></i>List Stock</a>
                        </li>
                        <li class="has-sub">
                            <a href="<?php echo base_url('admin/vendors/index');?>">
                                <i class="fas fa-map-marker-alt"></i>Vendor</a>
                        </li>
